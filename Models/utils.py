...
class HousePrice():
    ...
    def load_model(self):
        with open(r"C:\Users\Rahul\Desktop\bengaluru house\Models\LR_Model.json",'r') as f:
            self.json_dict=json.load(f)

        with open(r"C:\Users\Rahul\Desktop\bengaluru house\Models\LR_Model.pkl",'rb') as f:
